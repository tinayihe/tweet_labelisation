...
if (!(isset($_SESSION["newcomer"]))) {
    redirect("captcha.php");
    exit();
}

if ($_SESSION["newcomer"] != "c3a64a7c4d10143876e10420158c4d0bd9453e2c76adc5c3f7d5854ae1ee1d49f89cb6b1d0ff799a79207e8a8c0e6867bef6518e5268346447421cb51aad6a51") {
    redirect("captcha.php");
    exit();
}
